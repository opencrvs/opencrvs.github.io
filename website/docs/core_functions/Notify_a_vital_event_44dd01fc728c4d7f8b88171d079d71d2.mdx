...
This functionality allows a [**Registration Agent**](https://www.notion.so/Registration-Agent-7fe5e31c8fae4d3981e0d4f69576c084) or a [**Registrar**](https://www.notion.so/Registrar-3a66b6ccf39b49708baebeb802e1bc1f) to view birth and death notifications sent from external health facilities. These notifications appear in in the "In-Progress" workqueue as they require follow up work to complete all mandatory fields.
