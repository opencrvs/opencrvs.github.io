...
- A [**Registration Agent**](https://www.notion.so/Registration-Agent-7fe5e31c8fae4d3981e0d4f69576c084) to submit a correction request to the Registrar with all required supporting documentation
- A [**Registrar**](https://www.notion.so/Registrar-3a66b6ccf39b49708baebeb802e1bc1f) to review and formally request the correction by the relevant authority.
