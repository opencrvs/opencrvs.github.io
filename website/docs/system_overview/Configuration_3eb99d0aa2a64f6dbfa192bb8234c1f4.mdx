...
To configure your resources package, follow the [technical documentation](../technology/technologyIntroduction) and the instructions detailed in [GitHub for an example configuration for Zambia](https://github.com/opencrvs/opencrvs-zambia#can-you-explain-the-resources-module-features-in-more-detail).
