...
For more information how interoperability works, check out the [technical documentation](../technology/technologyIntroduction), especially the role of OpenHIM, [configurability](./configuration), and the [README in the code](https://github.com/opencrvs/opencrvs-core).
