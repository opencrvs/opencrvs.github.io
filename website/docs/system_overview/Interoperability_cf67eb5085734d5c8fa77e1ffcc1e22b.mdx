...
3. To create a National ID for a new registration when the event occurs. Refer to the [MOSIP](https://www.mosip.io/) [mediator](../technology/mediator)
...
For more information how interoperability works, check out the [technical documentation](../technology/technologyIntroduction).
