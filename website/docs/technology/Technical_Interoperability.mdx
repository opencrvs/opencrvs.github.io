...
- Documentation for including biometrics to this payload using [Simprints - last mile biometric identification for universal health coverage](https://www.simprints.com/).
