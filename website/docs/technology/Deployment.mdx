...
Once you have configured your resources module and you have OpenCRVS running locally as you like, you are ready to provision and deploy OpenCRVS.
...
`yarn deploy:qa <Your host> <Your contauiner version - explained below> <path to your resources package>`
