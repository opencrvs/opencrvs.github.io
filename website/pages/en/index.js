      ...
      return (
        <div className="productShowcaseSection paddingBottom">
          <div className="openCrvsApp">
            <img src="img/openCrvsApp.png" alt="OpenCRVS Application" />
          </div>
              ...
              <div className="blockContent">
                ...
                <div>
                  <span>
                    <ul className="bullets">
                      <li>
                        Simplified application process that includes reduced
              ...
              <div className="blockContent">
                ...
                <div>
                  <span>
                    <ul className="bullets">
                      <li>
                        Works with other e-government systems as a foundation
                        for effective ID management
                      </li>
                      <li>
        ...
        <div className="wrapper wrapperTitle">
          ...
          <div className="gridBlock processBlock">
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                ...
                <p>
                  This is an optional step to collect a minimal set of vital
                  event data that can be used for (i) planning and (ii)
                  follow-up purposes. In OpenCRVS we call it an “in-progress”
                  application because action is required to complete it. You can
                  receive an “in-progress” application from the OpenCRVS
                  application (as an incomplete application) as well as a number
            ...
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                <div className="processImage">
                  <img src="img/process1.png" alt="Notify a vital event" />
                </div>
              </div>
            </div>
          </div>
          <div className="gridBlock processBlock">
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                <div className="processImage">
                  <img src="img/process2.png" alt="Declare a vital event" />
                </div>
              </div>
            </div>
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                ...
                <p>
                  ...
                  OpenCRVS we call this an "application" as it is more familiar
                  to service providers - all mandatory information + supporting
          ...
          <div className="gridBlock processBlock">
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                ...
                <p>
                  In OpenCRVS, this is ideally done in one step. In the “Ready
                  to Review” workqueue, the Registrar (or Registration Agent)
                  can find all applications sent from the field, review them
                  alongside supporting documents, and then either reject or
                  register them.
                </p>
          ...
          <div className="gridBlock processBlock">
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                <div className="processImage">
                  <img src="img/process4.png" alt="Issue a certificate" />
                </div>
              </div>
            </div>
            <div className="blockElement twoByGridBlock">
          ...
          <div className="gridBlock processBlock">
            <div className="blockElement twoByGridBlock">
              <div className="blockContent processContent">
                ...
                <ul className="bullets">
                  <li>
                    <b>Vital statistics export:</b> export your civil
                    registration data in a standard format that can be used in a
